...
# top-left
plot(dat$DateTime, dat$Global_active_power, ylab = "Global Active Power", 
     xlab = "", type = "l")
# top-right
plot(dat$DateTime, dat$Voltage, ylab = "Voltage", 
...
# bottom-right
plot(dat$DateTime, dat$Global_reactive_power, ylab = "Global_reactive_power", 
     xlab = "datetime", type = "l")
dev.off()
